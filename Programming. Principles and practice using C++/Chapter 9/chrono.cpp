/*
 *  Данная программа реализует класс для представляения даты
 *
 *  Формат даты: год, месяц, день
 *
 *  Поддерживаемые операции:
 *  - добавление/вычитание указываемого количества дней
 *  - добавление/вычитание указываемого количества месяцев
 *  - добавление/вычитание указываемого количества лет
 *  - сравнение на совпадение двух дат
 *  - вывод даты в виде (гггг.мм.дд)
 */
